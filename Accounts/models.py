...
class ServiceRegister(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE,related_name='servicerequest_category')    
    subcategory = models.ForeignKey(Subcategory, on_delete=models.CASCADE,related_name='servicerequest_subcategory') 
