...
class ServiceRequest(models.Model):
    ...
    # reviews = models.ManyToManyField(CustomerReview, related_name='service_requests', blank=True)
    def __str__(self):
...
class CustomerReview(models.Model):
    ...
    service_request = models.ForeignKey(ServiceRequest, on_delete=models.CASCADE, related_name='reviews', null=True)
    def __str__(self):
