...
from .models import OTP, AdCategory, AdManagement, Category, Collar, Customer, CustomerReview, Dealer, District, Franchise_Type, Franchisee, Invoice, Service_Type, ServiceProvider, ServiceRegister, ServiceRequest, State, Subcategory, User, Country_Codes
...
admin.site.register(AdManagement)
