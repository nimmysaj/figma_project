...
from .serializers import ServiceProviderPasswordResetSerializer, SetNewPasswordSerializer, ServiceProviderLoginSerializer
...
class ServiceProviderPasswordResetView(generics.GenericAPIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        reset_link = f"http://127.0.0.1:8000/api/service-provider/password-reset/{uid}/{token}/"
        ...
        #     )
        #     print(message.sid)
            return Response({'details': 'Password reset link has been sent to your email or phone.'}, status=status.HTTP_200_OK)
