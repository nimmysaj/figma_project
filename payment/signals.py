...
def update_franchisee_status(sender, instance, created, **kwargs):
    # Check if the invoice is newly created
    if created:
        # Check if the payment is paid and fully paid
        ...
        print("Invoice was updated, not newly created and franchisee : {franchisee}is Active")