...
from service_provider.views import VerifyOTPAndSetPasswordView
...
urlpatterns = [
    ...
    path('password-reset/', VerifyOTPAndSetPasswordView.as_view(), name='customer-password-reset-confirm'),
    #profile update
