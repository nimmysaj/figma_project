...
from Accounts.models import Invoice, PaymentRequest, ServiceProvider, ServiceRegister, ServiceRequest, Subcategory, User  
...
class PaymentRequestSerializer(serializers.ModelSerializer):
    ...
    supporting_documents = serializers.FileField(required=True)