...
from .views import CustomerServiceRequestView, PaymentRequestCreateView, ServiceProviderLoginView, ServiceProviderPasswordForgotView, ServiceProviderPasswordForgotView, ResetPasswordView, ServiceProviderRequestsView, ServiceProviderViewSet, ServiceRegisterViewSet, ServiceRequestInvoiceView, SetNewPasswordView
...
urlpatterns = [
    ...
    path('payment-request/', PaymentRequestCreateView.as_view(), name='payment-request-create'),
